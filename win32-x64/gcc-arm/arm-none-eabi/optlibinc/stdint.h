...
#if INT_MAX >= 0x7f
#define INT_FAST8_MIN   (-(INT_MAX)-1)
#define INT_FAST8_MAX   (INT_MAX)
#define UINT_FAST8_MAX  ((INT_MAX)*2U+1U)
#else
...
#if (INT_MAX) >= 0x7fff
#define INT_FAST16_MIN  (-(INT_MAX)-1)
#define INT_FAST16_MAX  (INT_MAX)
#define UINT_FAST16_MAX ((INT_MAX)*2U+1U)
#else
...
#define INT_FAST32_MIN  (-(INT_MAX)-1)
#define INT_FAST32_MAX  (INT_MAX)
#define UINT_FAST32_MAX ((INT_MAX)*2U+1U)
#else
...
#if (INT_MAX) > 0x7fffffff
#define INT_FAST64_MIN  (-(INT_MAX)-1)
#define INT_FAST64_MAX  (INT_MAX)
#define UINT_FAST64_MAX ((INT_MAX)*2U+1U)
#else
...
#define SIG_ATOMIC_MIN (-(INT_MAX) - 1)
